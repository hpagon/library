...
class Media {
  ...
  personBolded = document.createElement("b");
  personDiv = document.createElement("div");
  lengthBolded = document.createElement("b");
  lengthDiv = document.createElement("div");
  typeBolded = document.createElement("b");
...
class Movie extends Media {
  constructor(director, title, length, seen) {
    super(title);
    this.type = "Movie";
...
class TVSeries extends Media {
  constructor(director, title, episodes, seen) {
    super(title);
    this.type = "TV Series";
    this.director = director;
